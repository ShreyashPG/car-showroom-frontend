...
// } from "../../components/EModule/API_Routes";
...
//       "employee_certificate_course": getAllRecordsCertificateStud,
     
//       "employee_event_participated": getAllRecordsParticipation,
//       "employee_event_organized": getAllRecordsOrganized,
...
const Report = () => {
  ...
  const tableMapping = {
    ...
    "employee_research_publication": "research-pb",
  ...
  const tableRoutesMapping = (table) => {
    const tableRoute = {
      ...
      "employee_conference_publication": getAllRecordsConferenceStud,
      "employee_certificate_course": getAllRecordsCertificateStud,
      "employee_sports_data": getAllRecordsSport,
      "employee_event_participated": getAllRecordsParticipation,
      "employee_event_organized": getAllRecordsOrganized,
      "employee_technical_events": getAllRecordsTechnicalStud,
      "employee_higher_education": getAllRecordsHigherEdu,
    };
    console.log("Returned table:", tableRoute[table]);
    return tableRoute[table];
  };
  ...
  const alternativeTableNames = {
    // "19_employee_dummy": "19_employee_dummy",
    ...
    "employee_event_organized": "Employee Event Organized",
    "employee_event_participated": "Employee Event Participated",
    "employee_higher_education": "Employee Higher Education",
    "employee_internship_details": "Employee Internship Details",
    // "employee_login": "employee_login",
    "employee_research_publication": "Employee Research Publication",
    "employee_sports_data": "Employee Sports Data",
    "employee_technical_events": "Employee Technical Events",
