...
export default function EventParticipated() {
  ...
  const handleFileUpload = async (files) => {
    ...
    try {
      ...
      queryParams.append("tableName", "employee_event_participated");
  ...
  const handleSubmit = async (e) => {
    ...
    // const requiredFields = ["Academic_Year", "Department", "Employee_Name", "Roll_No", "Class", "Email_ID", "Mobile_No", "Participant_or_Organizer", "Event_Name", "Name_of_Sub_Event", "Type_of_Event", "Individual_Role", "Organizer_Name", "Organizer_Type", "Place", "Start_Date", "End_Date", "Award", "Award_Prize_Money", "Remarks", "Geo_Tag_Photos"];
