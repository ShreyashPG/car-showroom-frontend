...
export default function Certificate() {
  ...
  const handleFileUpload = async (files) => {
    ...
    try {
      ...
      queryParams.append("tableName", "employee_certificate_course");
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ["Academic_Year", "Department", "Employee_Name", "Roll_No", "Class", "Certificate_Course_Title", "Organized_By", "Place", "Mode_of_Course", "Duration", "Start_Date", "End_Date", "Award", "Award_Prize_Money"];
