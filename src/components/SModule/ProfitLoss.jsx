...
import { addRecordsProfitLoss, uploadRecordsProfitLoss } from "./API_Routes";
...
export default function ProfitLoss() {
  ...
  const handleFileUpload = async (files) => {
    try {
      ...
      queryParams.append("tableName", "profit_loss_report");
      ...
      const url = `${uploadRecordsProfitLoss}?${queryParams.toString()}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(addRecordsProfitLoss, formDataWithFilePath);
      ...
      >
        ...
        <form className="mt-8 mb-2" onSubmit={handleSubmit}>
          ...
          <div className="mb-4 flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4 mb-4">
              <Typography variant="h6" color="blue-gray" className="mb-3">
                Type/Nature (Profit/Loss/Report etc)
              </Typography>
              <Select
                id="Type_Nature"
                size="lg"
